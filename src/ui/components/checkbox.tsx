	...
	return (
		...
		>
			<span className="relative flex h-4 w-4 items-center justify-center">
				...
				/>
				<span
					className={`flex h-4 w-4 items-center justify-center rounded-sm border transition-all duration-150 text-white peer-focus-visible:ring-2 peer-focus-visible:ring-mac-blue/50 peer-focus-visible:ring-inset ${
						isActive
