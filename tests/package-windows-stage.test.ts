...
describe('package windows helpers', () => {
  ...
  it('builds win32 packager options with Windows icon and asar unpack rules', () => {
    ...
    expect(options.asar).toEqual({
      unpackDir: '{vendor/ffmpeg,resources/pi,node_modules/@remotion,node_modules/esbuild,node_modules/@esbuild,node_modules/@puppeteer,node_modules/puppeteer-core,node_modules/sharp,node_modules/onnxruntime-node,node_modules/ffmpeg-static,node_modules/ffprobe-static,node_modules/playwright,node_modules/playwright-core,playwright-browsers,biliup}',
    });
  });
